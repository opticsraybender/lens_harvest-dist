...
This repository distributes the pre-built wheel (`lens_harvest-0.1.13-py3-none-any.whl`)
...
pip install lens_harvest-0.1.13-py3-none-any.whl
```

To upgrade later, reinstall with `--force-reinstall`:

```bash
pip install lens_harvest-0.1.13-py3-none-any.whl --force-reinstall
```
